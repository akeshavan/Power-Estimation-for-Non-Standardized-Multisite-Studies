...
\bottomrule
\end{tabular}
\caption{Top: Acquisition parameters for 9 of the 19 scanners. Si = Siemens, Ph = Phillips. Bottom: Test-retest reliabilities for selected ROIs, processed by Freesurfer.} \textbf{(Same comment as Table 1)}\textit{}
