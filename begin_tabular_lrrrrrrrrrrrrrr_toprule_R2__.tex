...
\caption{This table shows the scaling factor ($\hat{\alpha}$)  prediction results via ordinary least squares. The ROIs shown are those that remain after Bonferroni correction on the F statistic for the model.  }
\end{table}
